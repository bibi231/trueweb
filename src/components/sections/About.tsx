...
function FounderPortraitHover() {
  ...
  return (
    <a href="/founder" style={{ display: "block", borderRadius: 18, overflow: "hidden", position: "relative", flexShrink: 0, aspectRatio: "3/4", background: "var(--surface)" }}
      ...
      <img src="/founder/agbada.png" alt="Bitrus J-K Gadzama, founder TrueWeb Solutions" loading="lazy" decoding="async" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", transition: "opacity 0.5s", position: "absolute", inset: 0, opacity: hovered ? 0 : 1, borderRadius: 18 }} />
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/founder/hf_portrait.png" alt="Bitrus Gadzama" loading="lazy" decoding="async" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", borderRadius: 18, opacity: hovered ? 1 : 0, transition: "opacity 0.5s" }} />
    </a>
  );
}
